...
// Import our custom data structures from the models module (ai.rs file) for API communication and conversation management
use crate::models::{GenerateRequest, GenerateResponse, ChatRequest, ChatResponse, Message};
